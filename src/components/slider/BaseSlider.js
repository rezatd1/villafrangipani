        ...
        <div id={carouselId} className="carousel slide">
            <div className="carousel-inner">
                <div className="carousel-item active">
                    <img src={img[0].img} alt={title} className="d-block w-100" />
                ...
                {img.length > 1 ?
                    img.slice(1).map((item, index) => (
                        <div className="carousel-item" key={index}>
                            <img src={item.img} alt={title} className="d-block w-100" />
                            <div className="carousel-caption d-none d-md-block bg-light-blue-09 p-3">
            ...
            {img.length > 1 ?
                <>
                    <button className="carousel-control-prev" type="button" data-bs-target={`#${carouselId}`} data-bs-slide="prev">
                        <span aria-hidden="true"><img className='bg-middle-blue rounded-circle' alt='left arrow' src={leftArrow} /></span>
                        <span className="visually-hidden">Previous</span>
                    </button>
                    <button className="carousel-control-next" type="button" data-bs-target={`#${carouselId}`} data-bs-slide="next">
                        <span aria-hidden="true"><img className='bg-middle-blue rounded-circle' alt='left arrow' src={rightArrow} /></span>
