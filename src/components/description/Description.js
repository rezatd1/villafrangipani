...
export default function Description() {
    return (
        <div className='row bg-light-golden px-4 font-size-1-1 mx-3 mt-4 mb-5 d-flex justify-content-center'>
            ...
            <img className='col-9 col-lg-4 col-md-4 col-sm-9 cu-description-img ms-2 ms-lg-0 ms-md-0 ms-sm-2 mt-2' alt='Frangi Carving' src={img} />
        </div >
    )
}
