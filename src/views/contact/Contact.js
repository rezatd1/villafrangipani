      ...
      <form className="form">
        ...
        <div className="form__phone__wrapper wrapper">
          ...
          <div className="form__phone__number">
            ...
            <input type="text" id="number" placeholder={selectedCountry} />
          </div>
        </div>
        ...
        <div className="form__date wrapper">
          ...
          <div className="form__date__arrival wrapper">
            ...
            <input type="date" className="form__date__arrival__input" />
          </div>
          <div className="form__date__departure wrapper">
            ...
            {/* departure date */}
            <input type="date" className="form__date__departure__input" />
          </div>
        </div>
