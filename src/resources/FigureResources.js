const FigureResources = [
    ...
    },
    {
        ...
        img: null,
        title: 'Babysitter',
        text: 'A babysitter can also be organised for a small extra charge, should mums and dads want to explore dining options beyond the villa grounds.'
    },
    {
        id: 5,
        img: null,
        title: 'Children’s Meals',
        text: 'Although the kitchen is equipped with all you need to prepare simple meals for fussy eaters or babies, there’s also a special menu to suit children’s taste buds.  Plastic crockery and child size utensils are available.'
    },
    {
        id: 6,
        img: null,
        title: 'Beyond the Villa',
        text: 'When the excitement of exploring the villa starts to wear off, there’s plenty in the area to keep kids of all ages amused throughout the holiday.  We recommend Pererenan Beach, a short drive away for sunset walks, and flying kites, or surfing lessons can be arranged, even for beginners.   Other activities that may be of interest include -  white water rafting, and treks to stunning waterfalls, and rice terraces, or snorkeling trips.'
    },
];
export default FigureResources;